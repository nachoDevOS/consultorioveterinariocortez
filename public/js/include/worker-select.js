        ...
        $(document).ready(function(){
            ...
            $('#select-worker_id').select2({
                ...
                ajax: {
                    ...
                    url: window.workerListUrl, // Usa la variable global
                ...
                templateResult: formatWorkerResult,
                templateSelection: (opt) => {
                    window.workerSelected = opt; // Guarda en variable global
                    // workerSelected = opt;
                ...
                if(window.workerSelected){
                    $('#input-dni').val(window.workerSelected.ci ? window.workerSelected.ci : '');
                }
            });
        });

        function formatWorkerResult(option){
