<form action="{{ url('admin/ajax/worker/store') }}" id="create-form-worker" method="POST">
    <div class="modal fade" tabindex="-1" id="modal-create-worker" role="dialog">
        <div class="modal-dialog modal-primary">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" style="color: #ffffff !important"><i class="voyager-plus" ></i> Registrar Trabajador</h4>
                </div>
