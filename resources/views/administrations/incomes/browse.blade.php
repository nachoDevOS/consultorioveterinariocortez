                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 class="page-title">
                                <i class="fa-solid fa-cart-plus"></i> Orden de Ingresos
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px">
                            @if (auth()->user()->hasPermission('add_incomes'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2" style="margin-bottom: 10px">
                                <select id="typeIncome" name="typeIncome" class="form-control select2">
                                    <option value="" selected>Todos</option>
                                    <option value="Compra al Contado">Compras al Contado</option>
                                    <option value="Compra al Credito">Compras al Credito</option>
                                </select>
                            </div>
