...
@section('page_title', 'Viendo solicitudes de citas')
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 class="page-title">
                                <i class="fa-solid fa-inbox"></i> Viendo Citas
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px">
                            {{-- @if (auth()->user()->hasPermission('add_appointments'))
                            <a href="{{ route('voyager.appointments.create') }}" class="btn btn-success">
...
@section('javascript')
    ...
    <script>
        ...
        function list(page = 1){
            ...
            let url = '{{ url("admin/appointments/ajax/list") }}';
